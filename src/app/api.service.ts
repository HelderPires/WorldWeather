...
export class APIService {
  ...
  getCountries() {
  // The FREE API KEY is quite limited, as such I'll be returning a hardcoded object.

  //   const oldURL = 'https://restcountries.eu/rest/v2/all' // URL Provided
  //   const countryAPIKey = 'e9d59b73ddca1e6b95c502a7dc8196df' // API Link provided was broken, I've created this key for this exercise
